...
public class DeleteClientFactory {
  ...
  public static <T> DynamoDbResilienceDelete<T> createSyncClient(final DynamoDBMapper dynamoDBMapper,
  ...
  public static <T> DynamoDbResilienceDelete<T> createAsyncClient(final DynamoDBMapper dynamoDBMapper,
                                                         final BackoffExecutor backoffExecutor,
                                                         final ErrorRecoverer<T> errorRecoverer,
  ...
  public static <T> DynamoDbResilienceDelete<T> createAsyncClient(final DynamoDBMapper dynamoDBMapper, final ExecutorService executorService) {
