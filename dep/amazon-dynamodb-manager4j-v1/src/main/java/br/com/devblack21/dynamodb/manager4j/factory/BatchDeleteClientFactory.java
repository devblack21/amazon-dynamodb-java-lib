...
//    return ClientType.SYNC.createClient(dynamoDBMapper, transformer, backoffExecutor, errorRecoverer, null, requestInterceptor);
//  }
//
//  public static <T> BatchDeleteManager<T> createSyncClient(final DynamoDBMapper dynamoDBMapper,
//                                                           final FailedBatchDeleteRequestTransformer<T> transformer,
...
//                                                            final RequestInterceptor<T> requestInterceptor) {
//    return ClientType.ASYNC.createClient(dynamoDBMapper, transformer, backoffExecutor, errorRecoverer, executorService, requestInterceptor);
//  }
//
//  public static <T> BatchDeleteManager<T> createAsyncClient(final DynamoDBMapper dynamoDBMapper,
//                                                            final FailedBatchDeleteRequestTransformer<T> transformer,
...
//    SYNC {
//      @Override
//      <T> BatchDeleteManager<T> createClient(final DynamoDBMapper dynamoDBMapper,
//                                             final FailedBatchDeleteRequestTransformer<T> transformer,
//                                             final BackoffBatchWriteExecutor<T> backoffExecutor,
//                                             final ErrorRecoverer<T> errorRecoverer,
//                                             final ExecutorService executorService,
...
//    };
//
//    abstract <T> BatchDeleteManager<T> createClient(final DynamoDBMapper dynamoDBMapper,
//                                                    final FailedBatchDeleteRequestTransformer<T> transformer,
//                                                    final BackoffBatchWriteExecutor<T> backoffExecutor,
//                                                    final ErrorRecoverer<T> errorRecoverer,
//                                                    final ExecutorService executorService,
