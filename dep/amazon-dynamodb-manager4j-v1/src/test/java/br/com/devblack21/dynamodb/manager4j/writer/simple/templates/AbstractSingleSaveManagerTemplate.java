...
public class AbstractSingleSaveManagerTemplate extends AbstractSingleManagerTemplate {

  protected void simulateDynamoDbFailure(final DynamoDBMapper dynamoDBMapper) {
    doThrow(RuntimeException.class).when(dynamoDBMapper).save(any(MyItem.class));
  }
